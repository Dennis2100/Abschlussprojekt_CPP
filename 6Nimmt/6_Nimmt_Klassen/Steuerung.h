...
public:
	...
	bool PrüfeEingabe(int auswahl, Mensch * mensch);										//Prüfe ob der Eingegebene Index der Handkarten korrekt ist
	...
	/*bool PruefenAusgewaehlteKarte(int auswahl);	*/								//Prüfen der gelegten Karte ob sie kleiner ist als di Karten in der 4 Reihen
};
